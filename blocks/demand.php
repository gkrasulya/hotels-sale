...
<div id='form_div'>
	<form action='?demand=send' method="post" class="form" name="form" id="form"  >
		...
		<p>
			...
			<span class='little'>От</span> <input class='little' type="text" name="min_price" id="min_price" style='width: 100px'/>
			<span class='little'>до</span> <input class='little' type="text" name="max_price" id="max_price" style='width: 100px' />
		</p>

		<p>
			<label title="info" for="info">Дополнительная информация <br/>
				<span style='font-size:11px; font-style:italic;'>(максимально подробно опишите то, что Вас интересует):</label><br />
