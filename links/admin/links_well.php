...
if ($row_base[16]=="activ"&&$row_base[8]!="badly"&&$row_base[13]!="badly"&&$row_base[14]!="badly"&&$row_base[15]!="badly"&&$row_base[10]>=$_SESSION['adm_cy']&&$row_base[11]>=$_SESSION['adm_pr']&&$row_base[9]<=$_SESSION['adm_out_links']) { $tmp_array[$total_rows] = "$base_array[$i]"; $total_rows++; }
}
