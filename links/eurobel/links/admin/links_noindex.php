...
// ---------------------------------------------------------------------------------------------------------------------------------
// Готовим временный массив для функции разбиения на страницы  из активных ссылок badly и activ
$total_rows = 0;
...
// отбираем только с запретами индексации
