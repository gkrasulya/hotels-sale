...
if (isset($_GET['about'])) // About company
	{
		$about = $_GET['about'];
		$title = "- О компании";
		$about_link = " style='text-decoration:none;background-color:#eaeaff;color:#6ec6cd;border-right:5px solid #cbcbff;cursor:default;'";
	}
if (!isset($h) && !isset($r) && !isset($qwe) && !isset($about)) // Main page
	{
		$main_link = " style='text-decoration:none;background-color:#eaeaff;color:#6ec6cd;border-right:5px solid #cbcbff; cursor:default;'";
	}
