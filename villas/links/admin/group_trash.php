...
echo "<form action=cleartrash.php method=POST><table cellspacing=0 cellpadding=0 width=360>
      ...
      <tr><td bgcolor=#8f95ac width=1px></td><td bgcolor=#8f95ac align=center><input name=clear_trash style=\"width:180px;\" type=submit value=\"Очистить корзину\"></td><td bgcolor=#8f95ac width=1px></tr>
